...
class TemporalObjectCache:
    ...
    def append(
        ...
        self.cache[layer_idx] = clean_memory


    def get_frame_memory(
...
class DiTBlock(nn.Module):
    ...
    def __init__(
        ...
        self.gamma_temporal = nn.Parameter(
            1e-2 * torch.ones(dim)
            )
...
# =================================================
        ...
        self.temporal_object_attn = (
            TemporalObjectAttention(
                dim,
                heads
            )
        )
    ...
    def forward(
        ...
        if temporal_cache is not None:
            ...
            ), f"Expected {self.num_frames*self.tokens_per_frame} tokens, got {N}"
...
class DiT(nn.Module):
    ...
    def forward(
        ...
        temporal_cache = TemporalObjectCache()
...
for epoch in range(EPOCHS):
    ...
    torch.save(
        ...
        f"dit_S+T_epoch_{epoch+1}_ema.pth"
    )
